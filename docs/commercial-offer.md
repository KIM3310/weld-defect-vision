# Commercial Offer - Weld Defect Vision
...
| Entry price assumption | $5k-$15k PoC |
...
- Lead with the buyer's workflow: "For Manufacturing quality teams, welding inspection groups, industrial AI, and edge deployment reviewers, the hard part is often moving from proof to operating handoff without creating new risk."
- Use the proof hook: "I can show the first proof artifact (pytest passes), then map it to one workflow you already own."
- Use the metric hook: "The first scorecard can focus on mAP/recall by defect, not a vague AI transformation claim."
