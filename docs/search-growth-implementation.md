...
- Primary query: Weld Defect Vision detection dataset validation
- Secondary queries: Weld Defect Vision demo; Weld Defect Vision system architecture; Weld Defect Vision business tool; weld defect detection demo with dataset validation, model serving, and explainable inspection report service
- Public entry point: free static inspection demo and architecture page
