...
A determined plant could query the data directly and produce per-operator reports. The technical architecture does not prevent this. The guard is organizational and contractual.
