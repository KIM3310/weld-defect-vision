...
- **Performance evaluation of individual welders** without explicit labor / ethics review at the deploying site. See [`governance/ethics-architecture.md`](./ethics-architecture.md).
...
- Base material grade.
- Shift / operator cohort (with ethics review of per-operator analysis).
...
See [`governance/ethics-architecture.md`](./ethics-architecture.md) for the full ethics review. In summary:
